...
modelPath = currFile.replace('/demo/omega_demo/reachAvoid_env2_runningExample.py', '')
sys.path.append(modelPath)
factestPath = currFile.replace('/demo/omega_demo/reachAvoid_env2_runningExample.py', '/factest/synthesis')
