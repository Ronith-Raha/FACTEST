...
modelPath = currFile.replace('/demo/omega_demo/puzzle1.py', '')
sys.path.append(modelPath)
factestPath = currFile.replace('/demo/omega_demo/puzzle1.py', '/factest/synthesis')
...
if __name__=="__main__":
    ...
    b_workspace = np.array([0,15.5,0,15])
