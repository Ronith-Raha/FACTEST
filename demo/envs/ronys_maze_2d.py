...
#medium
b1 = np.array([10, -2, 3, -2.5])
b2 = np.array([0, 2.5, 3, -2.5])
b3 = np.array([10, -8, 0.5, 0])
b4 = np.array([6, 2.5, 0.5, 0])
b5 = np.array([10, -2, -2.5, 3])
b6 = np.array([0, 2.5, -2.5, 3])
...
b_init = np.array([8.75,-8,4.75,-4.25])
Theta = pc.Polytope(A, b_init)

b_goal = np.array([-1, 2, -3.5, 4.5])
G = pc.Polytope(A, b_goal)

b_workspace = np.array([10,2.5,5,5])
workspace = pc.Polytope(A, b_workspace)
